#!/bin/bash
# Training: max_label_len=1000 (2250 samples, 92.5% of data)
LOGFILE=/mnt/g/mimo_project/circuit_ocr/circuit-ocr-dataset/training_1000.log
rm -f "$LOGFILE"
...
python3 scripts/train_lora_light.py --rank 8 --alpha 16 --epochs 2 --max_label_len 1000 --grad_accum 4 2>&1 | tee -a "$LOGFILE"
