"""Step 4a: Projector LoRA r=16 — double LoRA rank for more capacity.
r=16, alpha=32, same targets (q/k/v/o + Projector linear_1/linear_2).
~5.7M trainable params (2x r=8). 3 epochs, all 2433 samples.
"""
...
save_path = f"{OUTPUT_DIR}/lora_projector_r16_fp16.pdparams"
