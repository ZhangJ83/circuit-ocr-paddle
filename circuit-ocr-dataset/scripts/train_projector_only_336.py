...
r=16, alpha=32, targets: mlp_AR.linear_1 + linear_2 only.
...
log(f"Projector-ONLY LoRA r=16: targets={TARGETS}")
...
save_path = f"{OUTPUT_DIR}/lora_projector_only_336_fp16.pdparams"
