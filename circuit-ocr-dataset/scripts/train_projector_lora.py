"""Step 1: Projector LoRA — add vision-language projector to LoRA targets.
Previous bottleneck: mlp_AR.linear_1 and linear_2 (25.9M params) are frozen.
This adds ~120K extra LoRA params. Train on larger subset, benchmark.
"""
...
log(f"Projector LoRA: targets={TARGETS}")
...
save_path = f"{OUTPUT_DIR}/lora_projector_fp16.pdparams"
