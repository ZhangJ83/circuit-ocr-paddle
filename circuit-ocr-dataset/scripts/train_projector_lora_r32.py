"""Step 2: Projector LoRA r=32 — quadruple LoRA rank for max capacity.
r=32, alpha=64, same targets (q/k/v/o + Projector linear_1/linear_2).
~11.5M trainable params (4x r=8). 3 epochs, all 2433 samples.
"""
...
log(f"Projector LoRA r=32: targets={TARGETS}")
...
save_path = f"{OUTPUT_DIR}/lora_projector_r32_fp16.pdparams"
