"""Projector+OProj LoRA: zero LLM attention LoRA, only visual-language bridge.
    ".*linear_1", ".*linear_2",    # Projector
    ".*o_proj",                   # Output projection only — minimal LLM adaptation
...
log(f"Projector+OProj LoRA r=16: targets={TARGETS}")
...
save_path = f"{OUTPUT_DIR}/lora_projector_oproj_fp16.pdparams"
