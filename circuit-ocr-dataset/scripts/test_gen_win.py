"""Test PaddleOCR-VL inference in Windows pyqpanda-quantum env (Paddle 2.6.2 GPU)."""
import os, sys
...
# ====== Monkey-patches (must be before paddleformers import) ======
...
for idx in range(3):
    ...
    print(f"\n[{idx+1}] {img_path.split('/')[-1]} ({image.size})", flush=True)
