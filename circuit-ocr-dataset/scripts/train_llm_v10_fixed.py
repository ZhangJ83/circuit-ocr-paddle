...
log(f"  Dataset: ocr_vl_sft-train-v11.jsonl (v4 synth 2000 + real KiCad 1839, NO Masala)")
...
# ── Data ──
with open(f"{DATASET_DIR}/ocr_vl_sft-train-v11.jsonl", encoding="utf-8") as f:
