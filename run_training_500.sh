#!/bin/bash
# Training: max_label_len=500 (1585 samples, 65% of data)
LOGFILE=/mnt/g/mimo_project/circuit_ocr/circuit-ocr-dataset/training_500.log
rm -f "$LOGFILE"
...
python3 scripts/train_lora_light.py --rank 8 --alpha 16 --epochs 2 --max_label_len 500 --grad_accum 4 2>&1 | tee -a "$LOGFILE"
